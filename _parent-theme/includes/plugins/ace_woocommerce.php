...
if(class_exists('WooCommerce')) {
  ...
  <style type="text/css">
    ...
    .woocommerce-product-search button {<?php if(get_option('ace_button_bg')) { ?>color: <?php echo get_option('ace_button_bg'); ?>;<?php } ?>}
    <?php } ?>
    ...
    .woocommerce-product-search button:hover {<?php if(get_option('ace_button_bg_hover')) { ?>color: <?php echo get_option('ace_button_bg_hover'); ?>;<?php } ?>}
    <?php } ?>
...
if(get_option('ace_woo_cart_menu')) {
  ...
  // ==================================================================
    ...
    add_filter('woocommerce_add_to_cart_fragments', 'ace_woo_add_to_cart_fragments', 10, 1);
