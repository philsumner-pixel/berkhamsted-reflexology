...
if(class_exists('Easy_Digital_Downloads')) {
  ...
  <style type="text/css">
    ...
    <?php if(get_option('ace_link')) { ?>
  	...
  	#edd_download_pagination .current {background: <?php echo get_option('ace_link'); ?>;}
    <?php } ?>
  ...
  // ==================================================================
  // Checkout thumbnails size
  // ==================================================================
  function ace_edd_checkout_image_size( $array ) {
      return array( 128, 0 );
  }
  add_filter('edd_checkout_image_size', 'ace_edd_checkout_image_size', 10, 1 );
